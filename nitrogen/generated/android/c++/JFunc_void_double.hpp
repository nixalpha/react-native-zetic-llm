...
namespace margelo::nitro::zeticllm {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/zeticllm/Func_void_double;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/zeticllm/Func_void_double_cxx;";
